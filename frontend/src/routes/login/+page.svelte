...
<style>
  ...
  .password-toggle { position: absolute; right: 1rem; top: 50%; transform: translateY(-50%); background: none; color: var(--accent); font-size: 0.75rem; font-weight: 600; padding: 0.5rem 0; }
</style>